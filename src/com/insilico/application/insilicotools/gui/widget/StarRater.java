...
public class StarRater extends JPanel {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent event) {
                if (isEnabled()) {
                    ...
                    int selection1 = 1 + (event.getX() / STAR_BACKGROUND_IMAGE.getWidth(null));
                    StarRater.this.selection = selection1>StarRater.this.stars?StarRater.this.stars:selection1;
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(starRater);
